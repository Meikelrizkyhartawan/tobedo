...
def generate_list_with_text() -> tuple:
    """
    Function to generate the list with text.
    Modify this function to generate your desired list and text.
    """
    text = "Here is the list:"
    items = ["Item 1", "Item 2", "Item 3"]
    return text, items

def send_list_with_text(bot):
    """
    Function to send the list with text.
    """
    text, items = generate_list_with_text()
    message = f"{text}\n\n"
    for item in items:
        message += f"- {item}\n"
...
def main() -> None:
    ...
    # Call the function to send the list with text
    send_list_with_text(updater.bot)
